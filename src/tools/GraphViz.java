package tools;// tools.GraphViz.java - a simple API to call dot from Java programs
...
/**
 * <dl>
 * <dt>Purpose: tools.GraphViz Java API
 * <dd>
 *
 * <dt>Description:
 ...
 * <dd>
 * <pre>
 *    tools.GraphViz gv = new tools.GraphViz();
...
public class GraphViz
{
     ...
     * creates a new tools.GraphViz object that will contain a graph.
     * Windows:
